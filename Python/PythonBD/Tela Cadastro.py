...
def exibir():
    ...
    var = IntVar()
    C1 = Checkbutton(frameL, text='Informática', variable=var, onvalue=1, offvalue=0, bg=co1)
    C1.place(x=10, y=140)
    C2 = Checkbutton(frameL, text='Alimentos', variable=var, onvalue=2, offvalue=0, bg=co1)
    C2.place(x=100, y=140)
    C2 = Checkbutton(frameL, text='Eletrônicos', variable=var, onvalue=3, offvalue=0,bg=co1)
